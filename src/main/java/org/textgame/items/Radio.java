...
public class Radio extends Item implements Attackable{
    ...
    public Attack getAttack() {
        return new Attack("Radio Smack",1,"Swing the radio around and hope for the best. Chance of adding " + AttackTypes.LIGHTNING.getAttackName() + " damage, maybe this old thing still works!.",AttackTypes.LIGHTNING);
    }
